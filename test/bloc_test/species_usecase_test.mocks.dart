...
class MockPokedexApiService extends _i1.Mock implements _i4.PokedexApiService {
  ...
  @override
  _i5.Future<_i3.DataState<_i7.SpeciesEntity>> getSpecies({int? speciesId}) =>
      (super.noSuchMethod(
              Invocation.method(#getSpecies, [], {#speciesId: speciesId}),
              returnValue: Future<_i3.DataState<_i7.SpeciesEntity>>.value(
                  _FakeDataState_1<_i7.SpeciesEntity>()))
          as _i5.Future<_i3.DataState<_i7.SpeciesEntity>>);
}
